...
public class SettingsActivity extends PreferenceActivity {
    ...
    private void setupSimplePreferencesScreen() {
        ...
        fakeHeader.setTitle(R.string.pref_header_powersave);
        ...
        */
        ...
        bindPreferenceSummaryToValue(findPreference("screen_mode"));
    }
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class PowersavePreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_powersave);
